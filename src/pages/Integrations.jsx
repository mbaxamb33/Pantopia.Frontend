      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        {gmailIntegration.isConnected && (
          <>
            ...
            {/* Big, very obvious dedicated refresh button */}
            <div className="mt-4 flex justify-center">
              <button
                onClick={handleRefreshGmailToken}
                disabled={isLoading}
                className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-200 flex items-center justify-center disabled:opacity-50 font-medium"
              >
                {isLoading ? (
                  <>
                    <Spinner size="sm" color="white" />
